...
std::map<std::string, Model*> prepareModels(std::map<std::string, Shader*> shaders, std::map<std::string, Texture*> textures) {
	...
	models.insert(std::pair<std::string, Model*>("HoursIndicator", new HoursIndicator(shaders["default"], textures["black"], glm::vec3(-1.0f, 2.75f, 0), (hours % 12) * 30 + (minutes / float(60)) * 30 + (seconds / float(60)) * 6)));
	models.insert(std::pair<std::string, Model*>("MinIndicator", new MinIndicator(shaders["default"], textures["black"], glm::vec3(-1.0f, 2.75f, 0), minutes * 6 + seconds * 0.1 )));
	models.insert(std::pair<std::string, Model*>("SecIndicator", new SecIndicator(shaders["default"], textures["black"], glm::vec3(-1.0f, 2.75f, 0), seconds * 6)));
	models.insert(std::pair<std::string, Model*>("ClockFace", new ClockFace(shaders["default"], textures["clockFace"], glm::vec3(-1.0f, 2.75f, 0))));
